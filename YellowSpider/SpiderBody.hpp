...
class SpiderBody
{
    ...
    private:
        ...
        glm::vec3 _startPoint{0.0, 0.0,  -45.0};
        glm::vec3 _pointTop0    {0.0, 7.0,  -44.0};
        glm::vec3 _pointTop1    {0.0, 17.5, -35.1};
        glm::vec3 _pointTop2    {0.0, 15.0, -20.0};
        glm::vec3 _pointTop3    {0.0, 7.5,  -10.0};
