...
std::vector<glm::mat4> Leg::getModels()
{
    ...
    float rotate0_deg = 44.0f;
    float rotate1_deg = 100.0f;
    float rotate2_deg = 65.0f;
    
    model2 = glm::translate(model2, glm::vec3(-2.3f, 7.2f, -5.84f));
    model2 = glm::rotate   (model2, glm::radians(rotate0_deg), glm::vec3(1.0f, 0.0f, 1.0f));
    model2 = glm::translate(model2, glm::vec3(0.0f, _seg0Length, 0.0f));
    model2 = glm::rotate   (model2, glm::radians(rotate1_deg), glm::vec3(1.0f, 0.0f, 1.0f));
    model2 = glm::translate(model2, glm::vec3(0.0f, _seg1Length, 0.0f));
    model2 = glm::rotate   (model2, glm::radians(rotate2_deg), glm::vec3(1.0f, 0.0f, 1.0f)); // c rotate
   
    model1 = glm::translate(model1, glm::vec3(-2.3f, 7.2f, -5.84f));
    model1 = glm::rotate   (model1, glm::radians(rotate0_deg), glm::vec3(1.0f, 0.0f, 1.0f));
    model1 = glm::translate(model1, glm::vec3(0.0f, _seg0Length, 0.0f));
    model1 = glm::rotate   (model1, glm::radians(rotate1_deg), glm::vec3(1.0f, 0.0f, 1.0f)); // b rotate
    
    model0 = glm::translate(model0, glm::vec3(-2.3f, 7.2f, -5.84f));
    model0 = glm::rotate   (model0, glm::radians(rotate0_deg), glm::vec3(1.0f, 0.0f, 1.0f)); // a rotate
